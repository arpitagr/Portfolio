...
jQuery('#gallery4').on('click', function (e) {
    ...
    jQuery(this).lightGallery({
        ...
        // Images
        dynamicEl: [{
            'src': 'images/photos/bb2.jpg',
            'thumb': 'images/photos/bb2.jpg',
            'subHtml': 'Tamen excepteur'
        }, {
            'src': 'images/photos/it2.jpg',
            'thumb': 'images/photos/it2.jpg',
            'subHtml': "Iudicem admodum"
        }, {
            'src': 'images/photos/QR1.jpg',
            'thumb': 'images/photos/QR1.jpg',
